...
class Environment {
  ...
  static String get notificationServerKey =>
      dotenv.env['NOTIFICATION_SERVER_KEY'] ?? 'MY_FALLBACK';
  static String get googleMapApiKey =>
      dotenv.env['GOOGLE_MAP_API_KEY'] ?? 'MY_FALLBACK';
  static String get socketBaseUrl =>
      dotenv.env['SOCKET_BASE_URL'] ?? 'MY_FALLBACK';
  static String get revenuecatAppleApiKey =>
      dotenv.env['PURCHASES_APPLE_API_KEY'] ?? 'MY_FALLBACK';
