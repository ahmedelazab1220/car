...
class DirectPriceWidget extends StatefulWidget {
  final OrderEntity data;

  const DirectPriceWidget({super.key, required this.data});

  @override
  State<DirectPriceWidget> createState() => _DirectPriceWidgetState();
}

class _DirectPriceWidgetState extends State<DirectPriceWidget> {
