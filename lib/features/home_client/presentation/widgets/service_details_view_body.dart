...
import 'package:car_help/features/home_client/presentation/widgets/service_details_appbar.dart';
import 'package:car_help/features/home_client/presentation/widgets/service_details_images_widget.dart';
import 'package:car_help/generated/l10n.dart';
import 'package:flutter/material.dart';

class ServiceDetailsViewBody extends StatelessWidget {
  final ProviderEntity data;
  const ServiceDetailsViewBody({super.key, required this.data});
    ...
    return SingleChildScrollView(
      child: Column(
        ...
        children: [
          Stack(
            children: [
              ServiceDetailsAppBar(data: data),
              ServiceDetailsImagesWidget(data: data),
            ],
          ),
          Padding(
