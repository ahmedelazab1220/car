...
import 'package:car_help/features/orders/presentation/widgets/special_orders_view_controller.dart';
import 'package:car_help/features/widgets/tabbar_2.dart';
import 'package:car_help/generated/l10n.dart';
import 'package:flutter/material.dart';

class SpecialOrdersView extends StatelessWidget {
  const SpecialOrdersView({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    List<Widget> getViews() {
      return List<Widget>.generate(tabs.length, (index) {
        return SpecialOrdersViewController(
